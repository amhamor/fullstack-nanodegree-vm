...
menuItem2 = MenuItem(
    ...
    description=" A famous duck dish from Beijing[1] that has been "
                ...
                "the dish serving mostly the skin and little meat, sliced "
...
menuItem5 = MenuItem(name="Beef Noodle Soup",
                     description="A Chinese noodle soup made of stewed "
                                 "or red braised beef, beef broth, vegetables and Chinese noodles.",
...
menuItem6 = MenuItem(name="Ramen",
                     description="a Japanese noodle soup dish. "
                                 "It consists of Chinese-style wheat "
                                 "noodles served in a meat- or (occasionally) "
...
menuItem3 = MenuItem(name="Gyoza",
                     description="The most prominent differences between "
                                 "Japanese-style gyoza and Chinese-style jiaozi "
                                 "are the rich garlic flavor, which is less noticeable "
                                 "in the Chinese version, the light seasoning of Japanese "
                                 "gyoza with salt and soy sauce, and the fact that gyoza wrappers are much thinner",
...
menuItem1 = MenuItem(name="Tres Leches Cake",
                     description="Rich, luscious sponge cake soaked in sweet "
                                 "milk and topped with vanilla bean whipped cream and strawberries.",
...
menuItem3 = MenuItem(name="Honey Boba Shaved Snow",
                     description="Milk snow layered with honey boba, "
                                 "jasmine tea jelly, grass jelly, caramel, cream, and freshly made mochi",
...
menuItem4 = MenuItem(name="Cauliflower Manchurian",
                     description="Golden fried cauliflower florets in a "
                                 ...
                                 "fresh cilantro, celery, chilies,ginger & green onions",
...
menuItem5 = MenuItem(name="Aloo Gobi Burrito",
                     description="Vegan goodness. Burrito filled with "
                                 "rice, garbanzo beans, curry sauce, "
...
menuItem1 = MenuItem(name="Lamb Curry",
                     description="Slow cook that thang in a pool of "
                                 "tomatoes, onions and alllll those tasty Indian spices. Mmmm.",
                     price="$9.95", course="Entree", restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Tandoori Chicken",
                     description="Chicken marinated in yoghurt and seasoned with a spicy mix "
                                 "(chilli, tamarind among others) and slow cooked in a cylindrical "
                                 "clay or metal oven which gets its heat from burning charcoal.",
